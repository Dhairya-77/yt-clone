    ...
    <div class="bg-purple-800 rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <form method="post">
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" value="<?php echo $email;?>" class="w-full px-4 py-2 bg-purple-700 text-yellow-400 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400" placeholder="Enter your email">
                <label for="email" name="email_err_text" class="block text-red-500 mb-2"> <?php echo $email_err_msg; ?> </label>
            </div>
            <div class="mb-6">
        ...
        <p class="text-yellow-300 mt-6 text-center">Don't have an account? <a href="#" name="sign_up_text" class="text-yellow-400 underline hover:text-yellow-300">Sign up</a></p>
    </div>
</body>
</html>